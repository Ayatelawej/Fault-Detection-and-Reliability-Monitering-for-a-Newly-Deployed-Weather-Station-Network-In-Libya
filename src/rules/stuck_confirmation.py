...
def select_dominant_stuck_channels(
    ...
    for _, row in episodes_df.iterrows():
        ...
        if matching_events.empty:
            ...
            channel = str(matching_events.iloc[0]["channel"])
...
def main() -> None:
    ...
    expanded = select_dominant_stuck_channels(stuck, events)
    result = confirm_stuck_episodes(expanded)
